          ...
          <div className="p-[32px] bg-[#1A1A1A]  border border-[#262626] rounded-[12px]">
            ...
            <div className="flex lg:flex-row flex-col items-center justify-center gap-[20px]">
              <div
                ...
                className={`border-[2px]  rounded-[8px] w-[189px] h-[85px] flex flex-col gap-1 justify-center items-center ${
                  select
                    ? "bg-[#FF3D48] border-[#FF3D48]"
                    : "bg-transparent border-[#A6A6A6]"
                } `}>
                <img src={m1} alt="" />
                <p className="text-lg font-medium text-[#E2E8F0] leading-[28px] ">
                  Mobile Banking
                </p>
              </div>
              <div
            ...
            <div className="px-[12px] py-[16px] border border-[#FFFFFF21] rounded-[8px] bg-[#1C1C1C] lg:max-w-[606px] mx-auto w-full mt-[20px] ">
              <h2 className="text-[#F8FAFC] text-base font-bold leading-[24px] mb-[20px] ">
                Select Mobile Banking
              </h2>
              <div className="flex lg:flex-row flex-col gap-[20px] pb-10">
                <img className="w-full h-full" src={bkash} alt="" />
                <img className="w-full h-full" src={nogod} alt="" />
                <img className="w-full h-full" src={upay} alt="" />
              </div>
              {!complete && (
                <StepperButtons onNext={handleNext}>Pay 500 tk</StepperButtons>
              )}
            </div>
          </div>
        </div>
